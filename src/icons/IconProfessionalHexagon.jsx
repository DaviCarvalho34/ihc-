// icon:professional-hexagon | Material Design Icons https://materialdesignicons.com/ | Austin Andrews
import * as React from "react";

function IconProfessionalHexagon(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export default IconProfessionalHexagon;
